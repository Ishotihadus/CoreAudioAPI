...
namespace CoreAudio
{
    internal class AudioSessionEvents : IAudioSessionEvents
    {
        ...
        {
            _Parent.FireDisplayNameChanged(NewDisplayName, ref EventContext);
            return 0;
        }
        ...
        {
            _Parent.FireOnIconPathChanged(NewIconPath, ref EventContext);
            return 0;
        }
        ...
        {
            _Parent.FireSimpleVolumeChanged(NewVolume, newMute, ref EventContext);
            return 0;
        }
        ...
        {
            _Parent.FireChannelVolumeChanged(ChannelCount, NewChannelVolumeArray, ChangedChannel, ref EventContext);
            return 0;
        }
